...
const Footer = () => {
      ...
      const socialIcons = [
            { icon: FacebookIcon, link: "https://www.facebook.com/younus.always" },
            { icon: InstagramIcon, link: "https://www.instagram.com" },
            { icon: TwitterIcon, link: "https://twitter.com/younus-always" },
                  ...
                  <div className="max-w-7xl mx-auto">
                        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                              <div>
                                    ...
                                    <p className="max-w-102.5 mt-6 text-sm">Welcome to TroveShop, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                        ...
                        <p className="py-4 text-sm text-slate-500 text-center">
                              Copyright {new Date().getFullYear()} © TroveShop All Right Reserved.
                        </p>
                  </div>
            </footer>
      );
